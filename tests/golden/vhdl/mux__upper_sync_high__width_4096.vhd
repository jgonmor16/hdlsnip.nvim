...
-- template: mux   variant: upper_sync_high   case: width_4096
...
architecture golden of golden_wrapper is
  ...
  TYPE t_mux_inputs IS ARRAY (0 TO 3) OF std_logic_vector(4095 DOWNTO 0);

  SIGNAL mux_in : t_mux_inputs;
  SIGNAL mux_sel : natural RANGE 0 TO 3;
  SIGNAL mux_out : std_logic_vector(4095 DOWNTO 0);
