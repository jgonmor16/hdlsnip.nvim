...
-- template: counter   variant: long_names   case: sig_gold_sig
...
architecture golden of golden_wrapper is
  ...
  signal s_gold_sig_r : unsigned(7 downto 0) := (others => '0');

begin

  p_gold_sig : process (axi_aclk, axi_aresetn) is
  begin
    if axi_aresetn = '0' then
      s_gold_sig_r <= (others => '0');
    elsif rising_edge(axi_aclk) then
      if s_count_en = '1' then
        s_gold_sig_r <= s_gold_sig_r + 1;
      end if;
    end if;
